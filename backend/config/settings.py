...
SECRET_KEY = 'django-insecure-fws1_j3)a_pz8kun=9ap_)1x6v^uqw-1kbztn4u-90le#y*y4w'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'crm_db',                          # Имя базы данных
        'USER': 'crm_user',                        # Пользователь
        'PASSWORD': 'crm_password',                # Пароль
        'HOST': 'postgres_crm',                    # Имя контейнера с PostgreSQL
